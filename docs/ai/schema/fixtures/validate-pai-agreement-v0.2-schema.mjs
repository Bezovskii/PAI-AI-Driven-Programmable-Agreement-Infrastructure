...
const schemaPath = "docs/ai/schema/pai-agreement-v0.2.schema.json";
...
cases.push({
  id: "11_usdc_on_stellar",
  expectedValid: true,
  raw: "The price is 4,500 USD, settled in USDC on Stellar.",
  agreement: {
    ...baseAgreement(),
    parties: parties(),
    pricing: {
...
cases.push({
  id: "12_usdc_on_solana",
  expectedValid: true,
  raw: "The price is 4,500 USD, settled in USDC on Solana.",
  agreement: {
    ...baseAgreement(),
    parties: parties(),
    pricing: {
...
cases.push({
  id: "13_explicit_caip19_asset",
  expectedValid: true,
  raw: "Settle using the token at 0xaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa on Base.",
  agreement: {
    ...baseAgreement(),
    pricing: {
      total: usd4500(),
...
cases.push({
  id: "14_fiat_without_blockchain_network",
  expectedValid: true,
  raw: "Settle in USD by bank transfer.",
  agreement: {
    ...baseAgreement(),
    pricing: {
      total: usd4500(),
...
cases.push({
  id: "15_semantic_asset_network_mismatch_structurally_valid",
  expectedValid: true,
  raw: "Use the stated settlement asset.",
  agreement: {
    ...baseAgreement(),
    pricing: {
      total: usd4500(),
...
cases.push({
  id: "18_reject_noncanonical_party_id",
  expectedValid: false,
...
cases.push({
  id: "19_reject_incomplete_trigger",
  expectedValid: false,
  agreement: invalidMissingTriggerTiming,
});

const invalidLegacySettlementFields = baseAgreement();
invalidLegacySettlementFields.pricing.settlementAsset = {
  type: "token",
  symbol: "USDC",
  chainId: 8453,
...
cases.push({
  id: "20_reject_legacy_evm_settlement_fields",
  expectedValid: false,
  agreement: invalidLegacySettlementFields,
});

const invalidNumericNetworkId = baseAgreement();
invalidNumericNetworkId.pricing.settlementAsset = {
  type: "token",
  symbol: "USDC",
  networkId: 8453,
  assetId: null,
...
cases.push({
  id: "21_reject_numeric_network_id",
  expectedValid: false,
  agreement: invalidNumericNetworkId,
});

const invalidMalformedAssetId = baseAgreement();
invalidMalformedAssetId.pricing.settlementAsset = {
  type: "token",
  symbol: "USDC",
  networkId: "eip155:8453",
...
cases.push({
  id: "22_reject_malformed_asset_id",
  expectedValid: false,
  agreement: invalidMalformedAssetId,
});
